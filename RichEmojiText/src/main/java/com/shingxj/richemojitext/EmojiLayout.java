...
import com.shingxj.richemojitext.adapter.ExpressionPagerAdapter;
import com.shingxj.richemojitext.adapter.SmileImageExpressionAdapter;
...
public class EmojiLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            richMarginBottom = (int) array.getDimension(R.styleable.EmojiLayout_richMarginBottom, dip2px(getContext(), 3));
            ...
            numRows =  array.getInteger(R.styleable.EmojiLayout_richLayoutNumRows, 4);
